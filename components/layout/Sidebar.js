    ...
    <>
      ...
      <div
        className={`xs-sidebar-group info-group info-sidebar ${
          isSidebar ? "isActive" : "close-sidebar"
        }`}
      >
              ...
              <div className="sidebar-info-contents">
                <div className="content-inner">
                  ...
                  <div className="content-box">
                    <h4>About Us</h4>
                    <p>
                      At Vibe Event Management, we don’t just plan events — we craft unforgettable experiences. From intimate gatherings to grand celebrations, our team blends creativity, precision, and passion to bring your vision to life.
